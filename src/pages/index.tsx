  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again - Your ultimate marketplace bridging the gap between freelancers and companies offering jobs. Discover opportunities. Enhance your professional journey."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again - Your ultimate marketplace bridging the gap between freelancers and companies offering jobs. Discover opportunities. Enhance your professional journey.`}
            </Text>
            <Box
